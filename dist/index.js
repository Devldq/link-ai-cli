...
async function main() {
    try {
        ...
        if (majorVersion < 16) {
            console.error(chalk_1.default.red('❌ Error: Node.js 16.0.0 or higher is required'));
            console.error(chalk_1.default.yellow(`Current version: ${nodeVersion}`));
            console.error(chalk_1.default.blue('Please upgrade Node.js: https://nodejs.org/'));
            process.exit(1);
        }
        // 设置程序基本信息
        program
